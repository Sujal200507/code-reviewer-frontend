    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="relative max-w-7xl mx-auto px-6 py-20 text-center">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 right-10 w-72 h-72 bg-blue-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute bottom-40 left-10 w-72 h-72 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
        </div>

        <div className="relative z-10">
          <p className="text-gray-400 text-lg mb-4">✨ Used By 100+ Developers</p>
          
          <h1 className="text-6xl font-black mb-6 bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-400 bg-clip-text text-transparent">
          ...
          <div className="flex gap-6 justify-center mb-16">
            <Link 
              to="/review"
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold text-lg transition transform hover:scale-105 flex items-center gap-2"
            >
              🚀 Review My Code Now
            </Link>
            ...
            <Link 
              to="/features"
              className="border-2 border-blue-600 hover:bg-blue-600 text-blue-400 hover:text-white px-8 py-4 rounded-full font-bold text-lg transition"
            >
              Explore Features
            </Link>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 hover:border-blue-600 transition">
